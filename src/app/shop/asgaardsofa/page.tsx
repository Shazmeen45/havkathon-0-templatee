          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4">
              <p className="text-gray-600">
                Embodying the row, wayward spirit of rock n&apos; roll the
                Kilburn portable active stereo speaker takes the unmistakable
                look sound of Marshall unplugs the chords, and takes the show on
                the road.
              </p>
            </div>
            ...
            <div className="p-4">
              <p className="text-gray-600">
                ...
                of vintage styled engineering Setting the bar as one of the loud
                speakers in its class, the Kilburn is a compact stout-hearted
                hete with a well-balanced audio which boasts a clear midrom and
                extended mhighs for a sound that is both articulate and
                pronounced. Ine analogue knobs allow you to fine tune the contr
                to your personcar preferences while the gutor influenced lecther
                strop enables easy and stylish travel
              </p>
            </div>
          </div>
        </div>
